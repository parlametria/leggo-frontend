const filtro = {
  state: {
    ...
    regimeFilter: [{'tipo': 'Urgência', 'status': true }, {'tipo': 'Ordinária', 'status': true }, {'tipo': 'Prioridade', 'status': true }],
    casaFilter: [{'tipo': 'senado', 'status': true }, {'tipo': 'camara', 'status': true }],
    emPautaFilter: [{'tipo': 'Sim', 'status': true }, {'tipo': 'Não', 'status': true }]
