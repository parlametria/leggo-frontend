describe('Test proposicoes view', () => {
  ...
  it('Test filter apreciacao', () => {
    ...
    apreciacoes.forEach(apreciacao => {
      cy.get('forma-apreciacao').should('contain', apreciacao)
      cy.contains('.is-checked', apreciacao).click()
      cy.get('forma-apreciacao').should('not.contain', apreciacao)
  ...
  it('Test filter regime', () => {
    ...
    regimes.forEach(regime => {
      cy.get('regime-tramitacao').should('contain', regime)
      cy.contains('.is-checked', regime).click()
      cy.get('regime-tramitacao').should('not.contain', regime)
